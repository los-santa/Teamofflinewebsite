  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-16 py-24 relative overflow-hidden bg-black">
      <div className="mb-12 relative">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "inset 0 0 0 10px #000000, inset 0 0 0 14px #FFFFFF, 0 0 40px rgba(255,255,255,0.1)",
            minHeight: "320px",
            minWidth: "320px",
            ...
            >
              ...
              <text className="fill-white font-mono text-[10px] uppercase tracking-[0.4em]">
                <textPath xlinkHref="#curve" startOffset="0%">
                  • EST 2023 • PERSONAL DATABASE • WRITING SUPPLIES • SECOND BRAIN
                </textPath>
              </text>
            </svg>
          </div>
      ...
      <div className="text-center space-y-6">
        ...
        >
          PRESERVING DATA INTEGRITY THROUGH RIGOROUS ARCHIVAL
          STANDARDS.
        </p>
